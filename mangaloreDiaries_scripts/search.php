...
*/ 
 ...
 //$data = mysql_query("SELECT * FROM company WHERE upper($field) LIKE'%$find%'"); 
$name=mysql_real_escape_string($_POST['search']);
$name="'".$name."'";
$query="select * from company where name = $name or location=$name or category=$name ";
...
/*while($obj = mysql_fetch_object($result))
{
 ...
 echo "</br><b>Searched For:</b> " .$_POST['search']; 
 } 
